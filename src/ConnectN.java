...
public class ConnectN {
    ...
    public static void play(boolean skip) {
        public static Board board = new Board(8);
        int turn = 0;
        int n = 8;
        Piece p1 = new Piece("none", "player 1", 'R');
        Piece p2 = new Piece("none", "player 2", 'B');
